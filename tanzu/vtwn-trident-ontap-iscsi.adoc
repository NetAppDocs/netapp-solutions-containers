...
+
image:vtwn-025.png[iSCSI SVM Data LIFs]

. Enter the details for the SVM administration account, and then click Save.
+
image:vtwn-026.png[iSCSI SVM administration]
...
+
image:vtwn-027.png[SVM aggregate allocation]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/vtwn_trident_ontap_iscsi.adoc
