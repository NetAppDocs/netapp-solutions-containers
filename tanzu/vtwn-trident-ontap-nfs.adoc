...
+
image:vtwn-006.png[SVM Create with NFS]
+
...
+
image:vtwn-007.png[SVM Data LIFs and SVM administration]
...
+
image:vtwn-008.png[SVM aggregate allocation]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/vtwn_trident_ontap_nfs.adoc
