...
image:vtwn-002.png[VMware Tanzu Kubernetes Grid with management cluster]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/vtwn_overview_tkg.adoc
