...
summary: Log of recent changes to the NetApp container solutions collateral. 
---
= What's new in NetApp container solutions 
:icons: font
:imagesdir: ./media/

[.lead]
Learn what's new in container solutions.

== 21 September 2026
Added the VMware vSphere Kubernetes Service with NetApp ONTAP solution to NetApp container solutions: link:https://docs.netapp.com/us-en/netapp-solutions-containers/vsphere-kubernetes-service/vks-overview.html[vSphere Kubernetes Service solutions^].
