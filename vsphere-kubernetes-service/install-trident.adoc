...
[source,bash]
----
kubectl create -f tbc-nas.yaml -n trident
kubectl create -f sc-nas.yaml

kubectl create -f tbc-nas-economy.yaml -n trident
kubectl create -f sc-nas-economy.yaml

kubectl create -f tbc-iscsi.yaml -n trident
kubectl create -f sc-iscsi.yaml

kubectl create -f tbc-nvme.yaml -n trident
