...
[source,cli]
----
helm install trident netapp-trident/trident-operator --version 100.2606.0 --create-namespace --namespace trident --kubeconfig=<path/your-kubeconfig-file>

or if you want to specify a debug mode, you can use the following command:
