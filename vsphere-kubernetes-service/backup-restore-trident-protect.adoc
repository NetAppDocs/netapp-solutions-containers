...
[%collapsible]
====
This example covers data protection for the sample PostgreSQL application, which is installed in the `postgres` namespace. For details about installation, see link:deploy-vks-workloads.html[Deploy VKS workloads using NetApp Storage].
