...
The persistent disks of VKS applications can be backed by ONTAP storage integrated with the VKS cluster using link:https://docs.netapp.com/us-en/trident/[Trident CSI]. This procedure uses link:https://docs.netapp.com/us-en/trident/trident-protect/learn-about-trident-protect.html[Trident Protect] to create snapshots and backups of applications, including their data volumes, to ONTAP object storage, and to restore from a snapshot or backup when needed.
...
image::vks-tp-018.png[Application objects deleted]
