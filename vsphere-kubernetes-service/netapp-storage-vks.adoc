...
summary: "Learn about the key benefits of using NetApp ONTAP storage with vSphere Kubernetes Service workloads."
---
...
For complete details on Trident, refer to the link:https://docs.netapp.com/us-en/trident/[Trident documentation^].

== Trident Protect

Trident Protect is installed separately from Trident. Before deployment, verify that your Kubernetes platform, storage backend, snapshot components, and object storage meet the link:https://docs.netapp.com/us-en/trident/trident-protect/trident-protect-requirements.html[Trident Protect requirements^].
...
For complete details on Trident Protect, refer to the link:https://docs.netapp.com/us-en/trident/trident-protect/learn-about-trident-protect.html[Trident Protect documentation^].
