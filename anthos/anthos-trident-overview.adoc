...
summary: "Trident is a fully supported, open-source storage orchestrator for containers and Kubernetes distributions, including Anthos."
---
...
See the link:https://docs.netapp.com/us-en/trident/index.html[Trident documentation^] for the latest version information. A support matrix for Trident version compatibility with Kubernetes distributions is available in link:https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators[Supported frontends (orchestrators)^].
...
See link:https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy.html[Trident installation details^] for more information.
...
link:anthos-trident-ontap-iscsi.html[Sample manifests for iSCSI protocol]

link:anthos-trident-ontap-nfs.html[Sample manifests for NFS protocol]




// NetApp Solutions restructuring (jul 2025) - renamed from containers/a-w-n_overview_trident.adoc
