...
image:a-w-n-netapp-overview.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/a-w-n_overview_netapp.adoc
