...
+
image:a-w-n-use-case-deploy-app-010.png[Registered Clusters]
...
+
image:a-w-n-use-case-deploy-app-009.png[Application Marketplace]

.	Search for the application you want to install, in this case WordPress.
+
image:a-w-n-use-case-deploy-app-008.png[Search For WordPress]

. After you select the WordPress application, an overview screen displays. Click the Configure button.
+
image:a-w-n-use-case-deploy-app-007.png[WordPress Overview Screen]
...
+
image:a-w-n-use-case-deploy-app-006.png[WordPress Configuration]
+
...
+
image:a-w-n-use-case-deploy-app-005.png[Application Details]
...
+
image:a-w-n-use-case-deploy-app-004.png[Kubectl get pods]
+
...
+
image:a-w-n-use-case-deploy-app-003.png[Application Running]
...
+
image:a-w-n-use-case-deploy-app-011.png[Services and Ingress]

. Click the `wordpress-wordpress-svc` service. This opens the Service Details screen. Click the Edit button at the top.
+
image:a-w-n-use-case-deploy-app-012.png[Edit Service Details]
...
+
image:a-w-n-use-case-deploy-app-013.png[Type ClusterIP Value]
+
image:a-w-n-use-case-deploy-app-014.png[Type LoadBalancer Value]
...
+
image:a-w-n-use-case-deploy-app-015.png[Service Details Final]
...
+
image:a-w-n-use-case-deploy-app-002.png[List Services]
...
+
image:a-w-n-use-case-deploy-app-001.png[Patch Service To Type LoadBalancer]
...
image:a-w-n-use-case-deploy-app-016.png[WordPress In Browser]



// NetApp Solutions restructuring (jul 2025) - renamed from containers/a-w-n_use_case_deploy_app_with_cloud_console.adoc
