...
image:a-w-n-anthos-baremetal-validation.png[Anthos BareMetal Physical Hardware Diagram]

image:a-w-n-anthos-baremetal-logical-topology.png[Anthos BareMetal logical Network Diagram]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/a-w-n_anthos_BM.adoc
