...
image:a-w-n-ontap-onpremises-virt-cloud.png["Figure showing input/output dialog or representing written content"]
...
For more information about NetApp AFF and FAS platforms, see the link:https://docs.netapp.com/platstor/index.jsp[NetApp hardware platform documentation^].
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/a-w-n_netapp_ontap.adoc
