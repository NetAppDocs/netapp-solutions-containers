...
NetApp Trident is an open-source, fully-supported storage orchestrator for containers and Kubernetes distributions, including Anthos. For more information, visit the link:https://docs.netapp.com/us-en/trident/index.html[Trident documentation^].
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/a-w-n_overview_storint.adoc
