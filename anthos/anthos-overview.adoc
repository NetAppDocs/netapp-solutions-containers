...
image:a-w-n-anthos-architecture.png["Figure showing input/output dialog or representing written content"]
...
For more information about Anthos clusters on VMware, deployed with NetApp, please visit the page link:anthos-vmw.html[here^].
...
For more information about Anthos on bare metal clusters deployed with NetApp, visit link:anthos-bm.html[here^].


// NetApp Solutions restructuring (jul 2025) - renamed from containers/a-w-n_overview_anthos.adoc
