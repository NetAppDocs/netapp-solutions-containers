...
---
= Watch videos on Red Hat OpenShift with NetApp
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Explore the integration of Red Hat OpenShift with NetApp through a series of videos demonstrating key capabilities such as disaster recovery, VM protection, storage management, and automation using Trident and Ansible.
