...
image:redhat-openshift-041.png[SVM creation on ONTAP]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_multitenancy_storage_admin_tasks.adoc
