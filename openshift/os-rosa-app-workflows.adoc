...
image:redhat-openshift-container-rosa-020.png[snapshot class]
...
image:redhat-openshift-container-rosa-021.png[volume snapshot]
...
image:redhat-openshift-container-rosa-022.png[database connect]

image:redhat-openshift-container-rosa-023.png[drop database]
...
image:redhat-openshift-container-rosa-024.png[postgresql clone from snapshot]

**b. Delete the original postgresql installation**

image:redhat-openshift-container-rosa-025.png[postgresql app delete]

**c. Create a new postgresql application using the new clone PVC**
[source]
$ helm install postgresql bitnami/postgresql --set primary.persistence.enabled=true --set primary.persistence.existingClaim=postgresql-volume-clone -n postgresql

image:redhat-openshift-container-rosa-026.png[postgresql new install]

**d. Verify that the application pod is in the running state**

image:redhat-openshift-container-rosa-027.png[postgresql new install]

**e. Verify that the pod uses the clone as its PVC**

image:redhat-openshift-container-rosa-028.png[postgresql new install describe]

image:redhat-openshift-container-rosa-029.png[new pvc is the clone]
...
image:redhat-openshift-container-rosa-030.png[database restored]
...
More videos on Red Hat OpenShift and OpenShift solutions can be found link:..videos/openshift-videos.html[here]. 

// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_rosa_solution_app_workflows.adoc
