...
image:redhat-openshift-064.png["Figure showing input/output dialog or representing written content"]

For more information about NetApp Element storage systems, visit the link:https://www.netapp.com/data-storage/solidfire/[NetApp Solidfire website^].
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_netapp_element.adoc
