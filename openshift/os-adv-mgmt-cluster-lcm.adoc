...
+
image:redhat-openshift-075.png[Add Provider connection]
+
...
+
image:redhat-openshift-076.png[Add clusters]
+
...
+
image:redhat-openshift-077.png[Import existing cluster]
+
.	After you create and import multiple clusters, you can monitor and manage them from a single console.


// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_advanced_cluster_management_features_cluster_lcm.adoc
