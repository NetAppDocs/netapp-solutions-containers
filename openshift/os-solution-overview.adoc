...
For more information, visit the link:https://docs.netapp.com/us-en/trident/index.html[Trident documentation^].
...
The releases listed in this matrix are the releases against which the solution was validated at the time of publication of this documentation.
...
Additional capabilities are continuously tested with the latest versions of ONTAP, NetApp Trident, and Red Hat OpenShift supported by Trident. For the latest OpenShift version supported by Trident, visit the link:https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators[Trident documentation^].


// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_solution_overview.adoc
