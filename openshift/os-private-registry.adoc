...
[.lead]
For most deployments of Red Hat OpenShift, using a public registry like link:https://quay.io[Quay.io^] or link:https://hub.docker.com[DockerHub^] meets most customer's needs. However there are times when a customer may want to host their own private or customized images.
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_private_registry.adoc
