...
image:redhat-openshift-086.png[Create resources]


// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_advanced_cluster_management_features_create_resources.adoc
