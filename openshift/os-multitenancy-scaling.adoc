...
image:redhat-openshift-042.png[Create SVM for scaling]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_multitenancy_scaling.adoc
