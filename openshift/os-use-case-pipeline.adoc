...
image:redhat-openshift-015.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-016.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-017.png["Figure showing input/output dialog or representing written content"]

. Click `Instantiate Template`.
+

image:redhat-openshift-018.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-019.png["Figure showing input/output dialog or representing written content"]

. The Jenkins pods take approximately 10 to 12 minutes to enter the Ready state.
+

image:redhat-openshift-020.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-021.png["Figure showing input/output dialog or representing written content"]

. Because OpenShift OAuth was used while creating the Jenkins app, click Log in with OpenShift.
+

image:redhat-openshift-022.png["Figure showing input/output dialog or representing written content"]

. Authorize the Jenkins service account to access the OpenShift users.
+

image:redhat-openshift-023.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-024.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-025.png["Figure showing input/output dialog or representing written content"]

. On the Create Item page, enter the name of your choice, select Pipeline, and click Ok.
+

image:redhat-openshift-026.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-027.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-028.png["Figure showing input/output dialog or representing written content"]
...
image:redhat-openshift-029.png["Figure showing input/output dialog or representing written content"]


// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_pipeline.adoc
