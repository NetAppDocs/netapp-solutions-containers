...
== Prerequisites
* link:https://portal.aws.amazon.com/billing/signup[AWS account^]
...
image::redhat-openshift-container-rosa-001.png[Rosa architecture]
...
image::redhat-openshift-container-rosa-002.png[FSxN created]
...
//NOTE: Depending on the version you install, the version parameter will need to be changed in the command shown. Refer to the link:https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-helm.html[Trident Helm installation documentation^] for the correct version number. For additional methods of installing Trident, refer to link:https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy.html[Learn about Trident installation^].
...
Prior to issuing the install command, you should have downloaded installer package. Refer to link:https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-tridentctl.html#step-1-download-the-trident-installer-package[Download the Trident installer package^]. 
...
image::rh-os-n-use-case-operator-001.png["Operator in Operator Hub"]

image::rh-os-n-use-case-operator-002.png["Install operator 1"]

image::rh-os-n-use-case-operator-003.png["Install operator 2"]

image::rh-os-n-use-case-operator-004.png["operator installed"]
...
image::rh-os-n-use-case-operator-005.png["orchestrator create"]

image::rh-os-n-use-case-operator-006.png["enable NodePrep"]

image::rh-os-n-use-case-operator-007.png["orchestrator installed"]

image::rh-os-n-use-case-operator-008.png["Trident installed"]
...
image::rh-os-n-use-case-iscsi-node-prep-001.png["iscsid active"]

image::rh-os-n-use-case-iscsi-node-prep-002.png["multipathd active"]

image::rh-os-n-use-case-iscsi-node-prep-003.png["multipath.conf file"]


**c.Verify that all Trident pods are in the running state**

image::redhat-openshift-container-rosa-003.png[Trident pods running]
...
image::redhat-openshift-container-rosa-004.png[AWS secrets Manager]

image::redhat-openshift-container-rosa-005.png[retrieve secret]
...
image::redhat-openshift-container-rosa-006.png[secret applied]
...
image::redhat-openshift-container-rosa-007.png[get lifs]
...
image::redhat-openshift-container-rosa-008.png[create backend]
...
image::redhat-openshift-container-rosa-009.png[create backend]
...
image::redhat-openshift-container-rosa-010.png[no PVCs using Trident]
...
image::redhat-openshift-container-rosa-011.png[create test PVC using Trident]
...
image::redhat-openshift-container-rosa-012.png[install postgresql]
...
image::redhat-openshift-container-rosa-017.png["postgresql table, schema, rows"]

image::redhat-openshift-container-rosa-018.png[postgresql row1]

image::redhat-openshift-container-rosa-019.png[postgresql rows2]


// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_rosa_solution_overview.adoc
