...
image:redhat-openshift-003.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_openshift_RHV.adoc
