...
.   Download the installation archive to the admin workstation and extract the contents. The current version of Trident can be downloaded from the link:https://github.com/NetApp/trident/releases?q=25.&expanded=true[Trident releases page on GitHub^].
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_overview_trident.adoc
