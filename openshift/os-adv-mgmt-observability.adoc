...
+
image:redhat-openshift-082.png[Observability home page]
+
...
+
image:redhat-openshift-083.png[Observe Pods]
+
...
+
image:redhat-openshift-084.png[Observe Nodes]
+
...
+
image:redhat-openshift-085.png[Observe Clusters]


// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_advanced_cluster_management_features_observability.adoc
