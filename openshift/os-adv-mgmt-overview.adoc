...
image:redhat-openshift-065.png[ACM architecture]

For more information, see the link:https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.2/[Red Hat Advanced Cluster Management documentation^].


// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_use_case_advanced_cluster_management_overview.adoc
