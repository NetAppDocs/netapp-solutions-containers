...
image:redhat-openshift-036.png["Figure showing input/output dialog or representing written content"]

image:redhat-openshift-037.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from containers/rh-os-n_openshift_BM.adoc
